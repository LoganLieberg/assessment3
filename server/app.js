...
var createHeroes = require('./public/routes/createHeroes');
var seeHeroes = require('./public/routes/seeHeroes');
...
app.use('/createHeroes', createHeroes);
app.use('/seeHeroes', seeHeroes);
